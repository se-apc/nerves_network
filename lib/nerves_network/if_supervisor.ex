defmodule Nerves.Network.IFSupervisor do
  ...
  # Return the appropriate interface IPv4 managers based on the interface's type
  # and settings
  @spec managers(:wired | :wireless, Nerves.Network.setup_settings) :: [Nerves.Network.StaticManager] | [Nerves.Network.LinkLocalManager] | [Nerves.Network.DHCPManager] | [Nerves.Network.WiFiManager] | []
